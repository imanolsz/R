stochastic.random.restart <- function(file, restarts, max_iterations = 50, count_print = 10, trace = FALSE) {
  ...
  for (i in 1:restarts) {
    ...
    result <- stochastic.hill.climbing(problem, max_iterations, count_print, trace)
